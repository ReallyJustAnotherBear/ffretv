 ...
 * Reworked for use with FFreTV
 *
 * This file is part of FFreTV.
 *
...
extern AVInputFormat ff_ffretv_mpegts_demuxer;
...
static int mpegts_read_header(AVFormatContext *s)
{
    ...
    if (s->iformat == &ff_ffretv_mpegts_demuxer) {
        /* normal demux */
        ...
        /* SDT Scan Removed here. It caused startup delays in TS files
           SDT will not exist in a stripped TS file created by ffre. */
#if 0
...
AVInputFormat ff_ffretv_mpegts_demuxer = {
    .name           = "mpegts",
...
AVInputFormat ff_ffretv_mpegtsraw_demuxer = {
    .name           = "mpegtsraw",
