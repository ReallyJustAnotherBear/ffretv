...
1) SOMEBODY WANTED MORE DIRECT ACCESS TO PROFITS BY A UPSTREAM CHANNEL.
2) UPGRADING THE CURRENT MPG2 to MP4/AVC h264/h265 was JUST TOO DAMN EASY 
3) CONVERTING TO OFDM AND USING WITH #2 above WAS ALSO JUST TOO DAMN EASY.
...
After all, with lil ole ATSC 2.0 , BIG TECH WOULD STILL DOMINATE IN OUR CAPITALIST SOCIETLY and THE FCC WOULD STILL NOT HAVE THE KEYS TO THE INTERNET PER SE, with a DAMN UPSTEAM CHANNEL FOR EVERY DEVICE THAT WATCHES TV. 

NOTE:
2.0 WAS SKIPPED FOR PROFIT ONLY. THAT IS THE ONLY REASON. WE COULD HAVE DONE FINE FOR ANOTHER 20 years with h264/h265 by switching to the INTERNATIONAL DVB FREQ STANDARD, THAT ALREADY EXISTS. YOU COULD HAVE EVEN PUT YOUR TENTACLE , I MEAN UPSTREAM CHANNEL IN, AKA EUROPA MONITOR 2.0
