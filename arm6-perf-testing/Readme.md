...
Next week I might wipe my hard drive and change all my rpm based servers over to debian/raspbian or mint if i so choose. The little RPI4 can compile qt5 in my configurations natively in a reasonable time, with the older pi, it took days and longer. Many reasons for me to switch to debian full on anyway. 

So yes debian people like it or not, im in your boat now, probably till my end too. I always read and heard that most people with any devlopment skills or ambitions eventually come to debian. It's just about my time too. I was quite bored with redhat anyway, all I learned with REDHAT and rpm building I can now use to bring to debian, if someone hasont already done it.
